...
<style>
  ...
  .answer {
    margin-top: 10px;
    color: #666;
    display: none; /* Sembunyikan jawaban secara default */
  }
  ...
  .star-icon {
    color: #ffd700; /* Warna kuning keemasan */
    font-size: 20px; /* Sesuaikan ukuran bintang */
    margin-left: 5px; /* Sesuaikan jarak ikon like */
  }
</style>
...
<body>
  ...
  <main>
    ...
    <!-- kalo mau nambahin pertanyaan nis -->
    <br><br>
  </main>
