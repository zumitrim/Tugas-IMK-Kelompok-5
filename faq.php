...
<br><br>
  <header>
    ...
    <section class="faq-section">
            <h2>Apa yang membedakan Bimba Cerdas dari bimbingan belajar lainnya?</h2>
            <div class="answer">
                <p>Bimba Cerdas memiliki pendekatan belajar yang menyenangkan dan holistik. Kami tidak hanya fokus pada akademik, tetapi juga pada pengembangan keterampilan sosial, emosional, dan kreativitas anak-anak</p>
            </div>
        </section>
        <section class="faq-section">
            <h2>Apa saja program bimbingan belajar yang ditawarkan untuk anak usia TK?</h2>
            <div class="answer">
        ...
        <section class="faq-section">
            <h2>Berapa lama durasi program bimbingan belajar di Bimba Cerdas?</h2>
            <div class="answer">
        ...
        <section class="faq-section">
            <h2>Bagaimana saya bisa mengetahui perkembangan anak saya selama mengikuti program bimbingan belajar?</h2>
            <div class="answer">
